...
export default function Restaurant() {
  ...
  return (
    <div className="bg-gray-900 min-h-screen">
      ...
      {/* Nouvelle Section Professionnelle pour restauration */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div>
                    <h2 className="text-3xl font-bold text-white mb-6">
                      Attirez de nouveaux clients et obtenez des avis pour votre établissement
                    </h2>
                    <p className="text-lg text-gray-300 mb-8">
                      Améliorez votre visibilité dans la région, encouragez les clients potentiels et construisez la réputation de votre restaurant avec de nouveaux avis. Plus de 15 propriétaires de restaurants ont déjà promu leur entreprise avec Visiloo. Rejoignez-les !
                    </p>
                    <Link 
                      href="/signin" 
                      ...
                      <div className="rounded-2xl bg-gradient-to-br from-blue-500/10 to-indigo-600/20 overflow-hidden flex items-center justify-center p-2">
                        <div className="relative w-full h-80">
                          ...
                          <div className="absolute inset-0 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-xl flex items-center justify-center">
                            <span className="text-white text-lg font-medium">Image de restaurant</span>
                          </div>
                        </div>
                      </div>
                    </div>
