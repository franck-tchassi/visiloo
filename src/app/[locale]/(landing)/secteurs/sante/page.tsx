                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div>
                    <h2 className="text-3xl font-bold text-white mb-6">
                      Faites en sorte que votre cabinet médical soit trouvé par des clients dans votre région.
                    </h2>
                    <p className="text-lg text-gray-300 mb-8">
                      Automatisez la gestion de votre profil Google Business, obtenez plus d'avis clients et améliorez la visibilité de votre entreprise dans la région ! Plus de 300 cabinets médicaux ont trouvé de nouveaux clients grâce à Visiloo.
                    </p>
                    <Link 
                      href="/signin" 
                      ...
                      <div className="rounded-2xl bg-gradient-to-br from-blue-500/10 to-indigo-600/20 overflow-hidden flex items-center justify-center p-2">
                        <div className="relative w-full h-80">
                          ...
                          <div className="absolute inset-0 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-xl flex items-center justify-center">
                            <span className="text-white text-lg font-medium">Image de sante</span>
                          </div>
                        </div>
                      </div>
                    </div>
