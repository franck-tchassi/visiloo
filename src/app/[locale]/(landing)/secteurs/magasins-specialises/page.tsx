...
export default function MagasinSpecialise() {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div>
                    <h2 className="text-3xl font-bold text-white mb-6">
                      Faites la promotion de votre offre et renforcez la visibilité de votre magasin local dans la région
                    </h2>
                    <p className="text-lg text-gray-300 mb-8">
                      Visiloo vous aide à atteindre de nouveaux clients recherchant des produits spécifiques dans la région, à améliorer la visibilité pour des mots-clés spécifiques et à collecter plus facilement des avis de clients satisfaits.
                    </p>
                    <Link 
                      href="/signin" 
                      ...
                      <div className="rounded-2xl bg-gradient-to-br from-blue-500/10 to-indigo-600/20 overflow-hidden flex items-center justify-center p-2">
                        <div className="relative w-full h-80">
                          ...
                          <div className="absolute inset-0 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-xl flex items-center justify-center">
                            <span className="text-white text-lg font-medium">Image de magasin</span>
                          </div>
                        </div>
                      </div>
                    </div>
