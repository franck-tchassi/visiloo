...
export default function Avocats() {
  ...
  return (
    <div className="bg-gray-900 min-h-screen">
      ...
      {/* Nouvelle Section Professionnelle pour beaute */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div>
                    <h2 className="text-3xl font-bold text-white mb-6">
                      Renforcez la réputation de votre cabinet et atteignez des clients potentiels.
                    </h2>
                    <p className="text-lg text-gray-300 mb-8">
                      Améliorez la visibilité de votre cabinet sur Google et gagnez en confiance. Localo vous aidera à atteindre de nouveaux clients et à obtenir plus d'avis pour votre profil. Rejoignez les centaines d'avocats qui promeuvent leur cabinet avec Visiloo !
                    </p>
                    <Link 
                      href="/signin" 
                      ...
                      <div className="rounded-2xl bg-gradient-to-br from-blue-500/10 to-indigo-600/20 overflow-hidden flex items-center justify-center p-2">
                        <div className="relative w-full h-80">
                          ...
                          <div className="absolute inset-0 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-xl flex items-center justify-center">
                            <span className="text-white text-lg font-medium">Image de avocat</span>
                          </div>
                        </div>
                      </div>
                    </div>
