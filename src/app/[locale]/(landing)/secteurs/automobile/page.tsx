...
export default function Automobile() {
  ...
  return (
    <div className="bg-gray-900 min-h-screen">
      ...
      {/* Nouvelle Section Professionnelle pour Garage */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl font-bold text-white mb-6">
                Attirez de nouveaux clients dans votre garage
              </h2>
              <p className="text-lg text-gray-300 mb-8">
                Automatisez la gestion de votre profil Google Business, obtenez plus d'avis clients et améliorez la visibilité de votre entreprise dans la région ! Plus de 900 garages et autres entreprises automobiles ont déjà trouvé de nouveaux clients grâce à Visiloo.
              </p>
              <Link 
                href="/signin" 
                ...
                <div className="rounded-2xl bg-gradient-to-br from-blue-500/10 to-indigo-600/20 overflow-hidden flex items-center justify-center p-2">
                  <div className="relative w-full h-80">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-xl flex items-center justify-center">
                      <span className="text-white text-lg font-medium">Image de garage</span>
                    </div>
                  </div>
                </div>
              </div>
     ...
     <section className="py-24 bg-gradient-to-b from-gray-900 to-gray-800">
      ...
      {/* Section Google Business Profile existante */}
      <section className="bg-gray-800 py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            {/* Colonne de gauche - Texte */}
